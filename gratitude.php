...
<html>
    <head>
        ...
        <title>Sorteavcu . Your request has been accepted!</title>
        <meta property="og:title" content="Sorteavcu . Your request has been accepted!" />
        <meta property="og:image" content="icon.svg"/>
        
        <meta property="og:description" content="Sorteavcu . Your request has been accepted!">
        <meta name="description" content="Sorteavcu . Your request has been accepted!"> 
        <meta name="twitter:title" content="Sorteavcu . Your request has been accepted!">
        ...
        <body>
          ...
          <header class="header navbar bcg padding-style flex-row-reverse" id="top">
            ...
            <div class="benefits bcg padding-style containerrs-thumbnail">
                <div class="container">
                    <div class="container-marquee-infinite">
                    <div class="marquee-infinite">
                           <div class="benefit1">
                               <h2>Experience a gradual, jitter-free awakening that keeps your mental clarity sharp throughout the entire workday.</h2>
                               <h2>Experience a gradual, jitter-free awakening that keeps your mental clarity sharp throughout the entire workday.</h2>
                           </div>
                    </div>
                    <div class="marquee-infinite">
                        <div>
                            <h2>Build a consistent morning routine combining aromatic beverages with mindfulness practices to reduce daily stress.</h2>
                            <h2>Build a consistent morning routine combining aromatic beverages with mindfulness practices to reduce daily stress.</h2>
                        </div>
                    </div>
                    </div>
            ...
            <div class="section-container-head padding-style">
                <div class="container">
                  <div class="container-head flex-row-reverse">
                      <div class="head-title">
                         <p>Awaken Your Mind With Morning Energy Sessions</p>
                         
                      </div>
                   <div class="image-container">        
                       <img src="media/album_2026-08-26_07-160.webp"  />
                   </div>
                  </div>
                </div>
            </div>
...
<style>
	* {
	...
	.bodyClass1-discountst-text{
		background: #fffaf6;
		color: #ffffff;
	}
	.bodyClass2-discountst-text{
		background: #fff;
		color: #fff;
	}
	.bodyClass3-discountst-text{
		background: #fff;
		color: #111;
	}
	.wrapage-block-discountst-text{
		background-size: 100%;
		width: 100%;
	}
	.box_main-discountst-text{
		width: 100%;
		margin: 0 auto;
		text-align: center;
		display: flex;
	...
	.box_main-discountst-text h2{
		font-size: 24px;
		padding: 0px 0px 25px;
	}
	.box_main-discountst-text p{
		font-weight: 500;
		font-size: 18px;
	}
	p{
	...
	.mainBlock-discountst-text{
		text-align: start;
	}
	.mainBlock-discountst-text ul{
		text-align: start;
		padding: 20px;
		display: flex;
	...
	.mainBlock-discountst-text ul>li span{
		font-weight: bold;
	}
	.mainBlock-discountst-text{
		max-width: 889px;
	...
	.mainBlock-discountst-text .cBlock-discountst-text{
		text-align: start;
	}

	.bodyClass3-discountst-text .mainBlock-discountst-text{
		background: none;
		border-top: 2px solid #eeecda;
		border-bottom: 2px solid #eeecda;
	}
	.bodyClass2-discountst-text .mainBlock-discountst-text{
		background: #3E432E;
		color: #fff !important;
		box-shadow: 0px 0px 0px #3E432E;
	}
	.bodyClass2-discountst-text .mainBlock-discountst-text p{
		color: #fff !important;
	}
	.bodyClass1-discountst-text .mainBlock-discountst-text{
		background: #B93058;
		color: #ffffff;
		border-left: 2px solid #310B0B;
	}
	.bodyClass1-discountst-text .mainBlock-discountst-text p{
		color: #ffffff !important;
	}
	.order-discountst-text{
...
<div class="bodyClass2-discountst-text" id="mainWrapp-discountst-text">


	<div class="wrapage-block-discountst-text">
		<div class="box_main-discountst-text">
			<div class="mainBlock-discountst-text">
...
<p class="cBlock-discountst-text">Warmest regards, The Team!</p>
			</div>
		</div>
	</div>
            ...
            <style>
              ...
              :root{
                  --inner-background-black: #44000D;
                  --inner-background-white: #f1d4d4;
              }
              li{
                  list-style: none;
              }
            ...
            .hero-button {
              ...
              background-color: #f1d4d4;
              box-shadow: 1px 1px 14px 1px #cc5b5c;
              animation: pulse 2s infinite;
             }
             @keyframes pulse {
             0% {
               transform: scale(1);
               box-shadow:  0px  0px 14px #cc5b5c;
             }
             50% {
               transform: scale(1.05);
               box-shadow:  0px  0px 18px #cc5b5c;
             }
             100% {
               transform: scale(1);
               box-shadow:  0px  0px 14px #cc5b5c;
             ...
             .hero-button:hover {
             box-shadow: 4px 4px 15px 4px #cc5b5c;
             }
            .image-container {
              overflow: hidden; 
             }
           ...
           .testimonial-section {
             ...
             .footer-contacts {
              ...
              .footer-contacts li.footer-contacts-id {
                list-style: none;
                max-width: 420px;
                line-height: 1.5;
                margin-top: 18px;
